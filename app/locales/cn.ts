...
const cn = {
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Mr.🆖 AI Lite 首发优惠，立刻解锁 OpenAI o1, GPT-4o, Claude-3.5 等最新大模型",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview: (overview: any) => {
        return `${overview.chat} 次对话，${overview.message} 条消息，${overview.prompt} 条提示词，${overview.mask} 个工具`;
      },
      ImportFailed: "导入失败",
    },
    Mask: {
      Splash: {
        Title: "工具启动页",
        SubTitle: "新建聊天时，展示工具启动页",
      },
      Builtin: {
        Title: "隐藏内置工具",
        SubTitle: "在所有工具列表中隐藏内置工具",
      },
    },
    Prompt: {
      Disable: {
    ...
    Usage: {
      ...
      SubTitle(used: any, total: any) {
        return `本月已使用 US$${used}，订阅总额 US$${total}`;
      },
      IsChecking: "正在检查…",
      Check: "重新检查",
    ...
    Access: {
      SaasStart: {
        ...
        Label: "获取您的 API Key",
        SubTitle:
          "由 Mr.🆖 维护, 性价比最高的方案，支持 GPT-4o, Claude-3.5, Gemini-1.5 等最新大模型",
        ChatNow: "开始註册一个账号",
      },
      AccessCode: {
        Title: "访问密码",
  ...
  Mask: {
    ...
    Page: {
      Title: "预设工具",
      SubTitle: (count: number) => `${count} 个预设工具定义`,
      Search: "搜索工具",
      Create: "新建",
    },
    Item: {
