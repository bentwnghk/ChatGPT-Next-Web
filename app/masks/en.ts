    ...
    context: [
      {
        ...
        role: "user",
        content:
          "Generate a vocabulary list for HKDSE English Language examination, in the format '**English word** [繁體中文定義] <word class>: example sentence 例句中文翻譯'. When finished, generate an MCQ cloze test for the list above.",
        date: "",
      },
      {
        id: "dse-vocab-1",
