...
function createEmptySession(): ChatSession {
  return {
    ...
    ttsConfig: {
      voice: (typeof window !== "undefined" && window.speechSynthesis.getVoices().find(voice => voice.name === "Microsoft Aria")) ? "Microsoft Aria Online (Natural) - English (United States)" : "Samantha",
      lang: "en-US",
    },
  };
}
